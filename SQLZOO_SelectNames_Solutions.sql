...
/*
1) You can use WHERE name LIKE 'B%' to find the countries that
start with "B".
*/
...
/*
5) Columbia starts with a C and ends with ia - there are two more like
this.
...
/*
9) Lesotho and Moldova both have two o characters separated by
...
Show the name and the extension where the capital is an extension of
name of the country.
*/
