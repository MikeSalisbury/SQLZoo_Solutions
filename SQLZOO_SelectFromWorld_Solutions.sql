-- SQLzoo Select From World solutions
...
Show the name for the countries that have a
...
for those countries with a population of at least
200 million.
*/
...
countries of the continent 'South America'. Divide the
...
/*
6) Show the countries which have a name that includes
the word 'United'
*/
SELECT name
FROM world
...
/*
7) Two ways to be big: A country is big if it has an
area of more than 3 million sq km or it has a population
...
/*
8) Exclusive OR (XOR). Show the countries that are big
by area or big by population but not both. Show name,
population and area. Australia has a big area but a
small population, it should be included.Indonesia has a
big population but a small area, it should be included.
...
$1000.
*/
SELECT name, ROUND(GDP/population, -3) AS 'GDP per capita in trillions'
FROM world
...
/*
12) The capital of Sweden is Stockholm. Both words start with the
letter 'S'.
...
/*
13) Equatorial Guinea and Dominican Republic have all of the vowels
